# RFDN 模型训练脚本
# python main.py --model RFDN --scale 4 --save RFDN_DIV2K_x4 --n_feats 48 --data_train DIV2K --data_test DIV2K --dir_data ../dataset --epochs 1000 --batch_size 64 --lr 5e-4 --reset --save_models

# E-RFDN baseline model (x4)
python main.py --model RFDN --scale 4 --n_feats 50 --patch_size 256 --batch_size 64 --epochs 1000 --loss 1*L1 --data_train DIV2K+Flickr2K --data_test Set5+Set14+B100+Urban100 --dir_data ../dataset --n_threads 6 --lr 5e-4 --decay 200-400-600-800 --save RFDN_x4 --reset --save_models
